...
void InitDefaultsSimpleRepeatedMessageImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_simple_2eproto::InitDefaultsSimpleMessage();
  {
...
void InitDefaultsSimpleRepeatedMessage() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsSimpleRepeatedMessageImpl);
}
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n\014simple.proto\022\022apollo.cyber.proto\".\n\rSi"
      "mpleMessage\022\017\n\007integer\030\001 \001(\005\022\014\n\004text\030\002 \001"
      "(\t\"K\n\025SimpleRepeatedMessage\0222\n\007message\030\001"
      " \003(\0132!.apollo.cyber.proto.SimpleMessage"
  };
...
SimpleRepeatedMessage::SimpleRepeatedMessage()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_simple_2eproto::InitDefaultsSimpleRepeatedMessage();
  }
  SharedCtor();
